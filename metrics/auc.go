...
// This file was originally written by Jason Aten, PhD, as a pull request
// to Gorgonia.
//
// The original intent was to make AUR an optimization target. The PR is ongoing.
// https://github.com/gorgonia/gorgonia/pull/400/
//
// However, the AUR code is very good and deserves to be used more.
// Hence the inclusion into the quality of life package - because it increases the quality of life.
